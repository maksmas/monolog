...
// shortDate returns "MM-DD" for same-year or "YY-MM-DD" for cross-year dates.
func shortDate(now, t time.Time) string {
	if t.Year() != now.Year() {
...
// Future timestamps within 1 minute tolerance (inclusive) -> "now"; further future -> "MM-DD".
